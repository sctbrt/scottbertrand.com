    ...
    const { error: emailError } = await resend.emails.send({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="https://clients.bertrandbrands.ca/portal" style="display: inline-block; background: #1a1a1a; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">
            View Client Portal
          </a>
          ...
          <p style="color: #999; font-size: 12px;">
            Bertrand Brands · bertrandbrands.ca
          </p>
        </div>
      `,
    })
